...
public class Create {
    ...
    public static void main(String[] args) {
        ...
        breakfastDishes.add(getDishObject("Breakfast 3", 3, getNutritionObject(200, 0, 0, 0)));
        ...
        lunchDishes.add(getDishObject("Lunch 3", 3, getNutritionObject(200, 0, 0, 0)));
        ...
        dinnerDishes.add(getDishObject("Dinner 3", 3, getNutritionObject(200, 0, 0, 0)));
